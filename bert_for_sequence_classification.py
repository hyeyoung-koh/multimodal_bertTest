...
# labels = torch.tensor([1]).unsqueeze(0)  # Batch size 1 #.unsqueeze(0)하는 이유: 텐서로 변환 위해
...
#BertForSequenceClassification 클래스
#이 클래스의 return type은 SequenceClassifierOutput또는 tuple(torch.FloatTensor)이다.
