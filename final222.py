...
#이번에는 shape가 torch.Size([8934,13])이다.
...
#print(mfcc_extracted_reshape.shape) #size가 [8934,13]이다. #이러면 size가 [1,116142]이다.
...
for i in tqdm(range(0,5)):
    ...
    print(list_last_hidden_states[i][0][0].shape) #이러면 size가 [1,768]이다.
