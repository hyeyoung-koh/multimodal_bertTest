...
#     myfile='D:\\0001-0400\\0001-0400\\clip_'+str(i)+'\\clip_'+str(i)+'.wav'
    ...
    aihub_final_inputs=tokenizer(aihub_inputs,return_tensors='pt') #이게 text의 inputs이다. #여기 tokenizer돌리는 부분
...
# for i in tqdm(range(1,3)):
    ...
    multimodal_sentiments=aihub_data.iloc[i,11]
    labels = torch.tensor(multimodal_sentiments) #얘가 찐 정답
